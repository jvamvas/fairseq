...
class FairseqTask(object):
    ...
    def build_generator(
        ...
        sampling_epsilon_cutoff = getattr(args, "sampling_epsilon_cutoff", 0.0)
        ...
        assert sampling_epsilon_cutoff < 0 or sampling, "--sampling-epsilon-cutoff requires --sampling"

        if sampling:
            search_strategy = search.Sampling(
                self.target_dictionary, sampling_topk, sampling_topp, sampling_epsilon_cutoff
            )
